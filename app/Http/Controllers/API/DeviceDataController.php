...
class DeviceDataController extends Controller
{
    ...
    // Mengambil ringkasan Harian dari tabel 'device_daily_summaries' dengan logika Scheduler (Cron Job)
    ...
    // Mengambil ringkasan Harian dari tabel 'device_daily_summaries' dengan logika agregasi on-demand
    protected function getDailySummary(Device $device, Request $request)
    {
        $request->validate([
            'start_date' => 'nullable|date_format:Y-m-d',
